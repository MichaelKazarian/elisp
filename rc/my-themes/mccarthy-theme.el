...
;; ---------------------------
;;
;; McCarthy: A gray color theme based on McCarthy color theme from
;; http://emacsthemes.caisah.info/mccarthy-theme/
...
(deftheme mccarthy "A gray color theme for Emacs")

(let ((*background*         "#edeef9")
      (*comments*           "#2c5115")
      (*constant*           "#2c5115")
      (*current-line*       "#d0d1d5")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-delimiter-face ((t (:italic t :slant italic :foreground, *comments*))))
   `(font-lock-comment-face ((t (:italic t :slant italic :foreground, *comments*))))
   `(font-lock-constant-face ((t (:italic t :slant italic :foreground, *constant*))))
   `(font-lock-doc-face ((t (:italic t :slant italic :foreground, *string*))))
   `(font-lock-doc-string-face ((t (:italic t :slant italic :foreground, *string*))))
   ...
   ;; show-paren
   `(show-paren-mismatch ((t (:background, "#8fbc8f" :foreground, *normal* :weight bold))))
   `(show-paren-match ((t (:background, "#8fbc8f" :foreground, *normal* :weight bold))))
